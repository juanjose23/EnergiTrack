...
<head>
    ...
    <title>EnergiTrack @yield('title')</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/Iconos/css/all.min.css') }}">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo  text-uppercase fw-bold ">EnergiTrack</span>
                    </a>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                <input type="text"
                                    class="form-control bg-transparent border-0 shadow-none ps-1 ps-sm-2"
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span
                                                        class="fw-medium d-block">{{ Session::get('nombre') }}</span>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                ...
                                <a href="" target="" class="footer-link fw-medium">EnergiTrack</a>
                            </div>
