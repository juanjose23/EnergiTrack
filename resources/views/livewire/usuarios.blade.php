                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-inline-block text-nowrap">
                                                ...
                                                @endcan
                                                @if ($colaborador->created_at->eq($colaborador->updated_at))
                                                <a href="{{ route('exportaciones.pdf', ['colaboradores' => $colaborador->id]) }}" class="btn btn-sm btn-icon delete-record">
